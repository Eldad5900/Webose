...
function normalizeEvent(
  ...
  return {
    ...
    chairsCommitment: data.chairsCommitment ?? '',
    spareChairs: data.spareChairs ?? '',
    authorizedSigner: data.authorizedSigner ?? '',
    arrivalConfirmationsCompany: data.arrivalConfirmationsCompany ?? '',
    seatingCompany: data.seatingCompany ?? '',
    seatingManagerPhone: typeof data.seatingManagerPhone === 'number' ? data.seatingManagerPhone : 0,
    ...
    seatingAllocationFileName: data.seatingAllocationFileName ?? '',
    seatingAllocationFileType: data.seatingAllocationFileType ?? '',
    seatingAllocationFileData: data.seatingAllocationFileData ?? '',
    alcoholMenuFileName: data.alcoholMenuFileName ?? '',
    alcoholMenuFileType: data.alcoholMenuFileType ?? '',
    alcoholMenuFileData: data.alcoholMenuFileData ?? '',
